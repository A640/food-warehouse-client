                ...
                <v-row>
                    <v-col cols="12" md="8" >
                        ...
                        <v-item-group mandatory>
                            <v-item v-slot="{ active, toggle }" class="mb-3"  >
                                <Address @click="toggle" v-for="address in addresses" :key="address.address_id" :address="address" :elevation="active ? 3 : 1" :class="active ? 'active-address' : ''"/>
                            </v-item>
                        </v-item-group>


                         <v-card class="pt-3 pl-3 pb-3 d-flex align-center justify-center">
                        ...
                        <v-card class="pt-3 pl-3 pb-3">
                            ...
                            <v-radio-group v-model="payment_type" class="ml-4">
                        ...
                        <v-card >
                            <div class="card-container cell">
                                ...
                                <div class="order-button cell">
                                    <v-btn :dark="total > 0" :disabled="!(total > 0)" color="green lighten-1" @click="nextStep()" >Zatwierdź</v-btn>
                                </div>
